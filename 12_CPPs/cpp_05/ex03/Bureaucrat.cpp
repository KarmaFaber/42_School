...
/*   Updated: 2025/11/14 11:56:30 by mzolotar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::incrementGrade(void)
{
	...
	this->_grade--;
	std::cout  << "[M] Bureaucrat incrementGrade method" << std::endl;  //revisar este mensaje
}
...
void	Bureaucrat::decrementGrade(void)
{
	...
	this->_grade++;
	std::cout  << "[M] Bureaucrat decrementGrade method" << std::endl; //revisar este mensaje
}
