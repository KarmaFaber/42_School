...
/*   Updated: 2025/09/25 08:44:07 by mzolotar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap(std::string name)
		  : ClapTrap(name)
{
	std::cout << CCYAN << "ScavTrap Attribute constructor called" << CRESET << std::endl;
	setHitPoints (100);
	setEnergyPoints (50);
	setAttackDamage (20);
}
...
ScavTrap::ScavTrap (const ScavTrap& other)
		  : ClapTrap(other)
{
	std::cout << CCYAN << "ScavTrap Copy constructor called" << CRESET << std::endl;
}
...
{
    std::cout << CCYAN << "ScavTrap Copy assignment operator called" << CRESET << std::endl;
    if (this != &other)
    {
